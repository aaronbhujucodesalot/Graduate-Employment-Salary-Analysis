...
## LinkedIn Post Idea
I recently completed a data analytics project exploring graduate employment and salary outcomes in New Zealand.

The project looks at how outcomes differ across fields of study, including median income, employment rate, further-study pathways, jobseeker outcomes, and long-term earnings growth.

What I enjoyed most was turning raw labour-market data into business-style insights: not just asking which degrees earn the most, but which fields offer the strongest balance of income, employment security, and long-term progression.

Tools used: Python, Pandas, SQL, SQLite, Matplotlib, and dashboard planning.